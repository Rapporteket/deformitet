...
key_data_table <- key_data %>% 
  ...
  mutate(Verdier = if_else(Variabler == "Prosentandel kvinner", paste(Verdier, "%", sep = ""), if_else(Variabler == "Pre Cobbvinkel", paste(Verdier, intToUtf8(176), sep = ""), paste(Verdier, "", sep = "")), paste(Verdier, "", sep = ""))) %>% 
